...
# xvfb-run -a ruby x-retrofit-manager-MINIMUM.rb 1234 user@email.com "HUB" "USA_IL_Chicago-OHare.Intl.AP.725300_TMY3" SmallOffice WholeBuilding 3 1000 “Metal” "Concrete Mass" 0.4 Rectangle 100 50
